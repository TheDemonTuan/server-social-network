...
export class DBPostService {
  ...
  public async findUnique(params: { where: Prisma.PostWhereUniqueInput; select?: Prisma.PostSelect; include?: Prisma.PostInclude }) {
    try {
  ...
  async update(params: { where: Prisma.PostWhereUniqueInput; data: Prisma.PostUpdateInput }) {
    try {
  ...
  async delete(data: Prisma.PostWhereUniqueInput) {
    try {
